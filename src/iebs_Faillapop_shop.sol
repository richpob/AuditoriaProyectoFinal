...
contract FP_Shop is AccessControl {
    ...
    modifier notBlacklisted() {
        require(!hasRole(BLACKLISTED_ROLE, msg.sender), "Seller is blacklisted");
        _;
    }
     ...
     *     @param price The price in Ether of the item being sold
     */
    function newSale(uint256 currentId, string calldata title, string calldata description, uint256 price)
        external
        notBlacklisted
    {
